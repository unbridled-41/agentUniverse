...
def get_memory_string(messages: List[Message], agent_id=None) -> str:
    ...
    Args:
        messages(List[Message]): The list of messages. Elements may also be
            str or dict, matching the input contract of generate_messages.
    ...
    string_messages = []
    for m in generate_messages(messages):
